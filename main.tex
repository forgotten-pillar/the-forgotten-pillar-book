...
\def\currentlang{sw} % currently: en, hr, pl, fr, sw, es, ar
\def\currentlayout{book-print} % all options: book-print, iso-a4, iso-a5, mobile, us-letter, us-letter-half

% Pre-calculate the font size into a macro
\edef\myfontsize{%
  \ifnum\pdfstrcmp{\currentlayout}{iso-a4}=0 14pt\else
    \ifnum\pdfstrcmp{\currentlayout}{us-letter}=0 14pt\else 12pt\fi
  \fi%
}
