...
\qrchapter{https://forgottenpillar.com/rsc/en-fp-chapter24}{مستقبل المبادئ الأساسية}
...
لقد قرأنا بالفعل الاقتباس التالي من فصل “\textit{أساس إيماننا}”. إنه أحد تنبؤات الأخت وايت عن الإصلاح العظيم الذي سيحدث بين الأدفنتست السبتيين؛ هذا الإصلاح سيتمثل في التخلي عن المبادئ الأساسية. هذه هي بالضبط الطريقة التي ستُنشأ بها المنظمة الجديدة.
...
\egw{\textbf{سعى عدو النفوس إلى إدخال الافتراض بأن إصلاحًا عظيمًا كان سيحدث بين الأدفنتست السبتيين، وأن هذا الإصلاح \underline{سيتمثل في التخلي عن العقائد التي تقف كأعمدة إيماننا} والانخراط في عملية إعادة تنظيم}. لو حدث هذا الإصلاح، ماذا ستكون النتيجة؟ \textbf{مبادئ الحق التي أعطاها الله في حكمته للكنيسة الباقية سيتم التخلي عنها. ستتغير ديانتنا. \underline{المبادئ الأساسية التي دعمت العمل خلال الخمسين سنة الماضية ستُعتبر خطأ}}. \textbf{ستُنشأ منظمة جديدة. ستُكتب كتب من نوع جديد. سيتم إدخال نظام من الفلسفة الفكرية}. مؤسسو هذا النظام سيذهبون إلى المدن ويقومون بعمل رائع. السبت، بالطبع، سيُنظر إليه باستخفاف، وكذلك الإله الذي خلقه. لن يُسمح لأي شيء بالوقوف في طريق الحركة الجديدة. سيُعلّم القادة أن الفضيلة أفضل من الرذيلة؛ لكن \textbf{بإزالة الله}، سوف \textbf{يضعون اعتمادهم على القوة البشرية}، التي بدون الله، لا قيمة لها. سيُبنى أساسهم على الرمال، وستجرف العاصفة والعواصف البناء.}[Lt242-1903.13; 1903][https://egwwritings.org/read?panels=p7767.20]
...
رأت إلين وايت جهد العدو لإزالة هذه \emcap{المبادئ الأساسية}. لقد دعمت العمل منذ البداية. كانت حقائق يشهد لها العمل المعجزي للروح القدس، ولا تقبل أي مساومة. \egwinline{ألا يجب أن نرفض كل ما ليس في انسجام مع هذا الحق؟}
...
تنبأت الأخت وايت لنا بالمستقبل. نحن نشهد تحقيقه اليوم. بمقارنة \emcap{المبادئ الأساسية} مع المعتقدات الأساسية اليوم، نرى أن ديانتنا قد تغيرت. معتقدنا بخصوص \emcap{شخصانية الله} قد تغير. تم تأليف كتب من نوع جديد، وهي ليست مبنية على كلمة الله الصلبة. تم إدخال نظام من الفلسفة الفكرية.
...
\egw{الوقت الحاضر هو وقت جدي ومخيف للكنيسة. الملائكة مستعدون بالفعل، ينتظرون أمر الله لسكب جامات غضبهم على العالم. ملائكة الهلاك يتولون عمل الانتقام، لأن روح الله ينسحب تدريجياً من العالم. الشيطان أيضاً يحشد قوات الشر لديه، ويذهب ‘إلى ملوك الأرض والعالم كله’، ليجمعهم تحت رايته، ليتم تدريبهم لـ ‘معركة ذلك اليوم العظيم، يوم الله القدير’. \textbf{سيبذل الشيطان أقوى الجهود للسيطرة في الصراع الأخير العظيم. \underline{ستُطرح المبادئ الأساسية، وستُتخذ قرارات بشأنها}. الشك سائد في كل مكان}. الفجور يكثر. \textbf{سيتم اختبار إيمان الأعضاء الفرديين في الكنيسة كما لو لم يكن هناك شخص آخر في العالم}...}[Ms1a-1890.8; 1890][https://egwwritings.org/read?panels=p6780.13]
...
أقوى جهود الشيطان هي إزالة \emcap{المبادئ الأساسية} عن طريق تغطيتها بالشك. وبالحكم من منظور اليوم، نشهد على صدق نبوءات إلين وايت.
...
\egw{أقول لكم الآن، أنه عندما أُوضع في قبري، \textbf{ستحدث تغييرات عظيمة}.}[Ms1-1915.2; 1915][https://egwwritings.org/read?panels=p10771.9]
...
السؤال الحقيقي الذي نطرحه على أنفسنا هو، عندما يتم إبراز \emcap{المبادئ الأساسية}، ما هو القرار الذي سأتخذه بشأنها؟ ألا يجب علينا أن نرفض كل ما لا ينسجم مع هذه المبادئ؟ ما هو القرار الذي ستتخذه؟
